...
export const configSchema = z.object({
  ...
  INTERACTION_TTS_MIN_INTERVAL_SECONDS: z.coerce.number().int().min(5).max(300).default(20),
  INTERACTION_TTS_GIFT_AWAITING_TEXT: z.string().min(10).max(500).default("{name}, gracias por tu regalo. Escribe tu pregunta en el chat para activar tu lectura de {cards}."),
