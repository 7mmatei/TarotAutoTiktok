...
export const configSchema = z.object({
  ...
  TAROT_FOCUS_ENABLED: envBoolean.default(true),
  TAROT_FOCUS_INITIAL_DELAY_SECONDS: z.coerce.number().int().min(15).max(3_600).default(35),
  TAROT_FOCUS_INTERVAL_SECONDS: z.coerce.number().int().min(30).max(3_600).default(55),
  TAROT_FOCUS_MAX_PER_SESSION: z.coerce.number().int().min(0).max(78).default(18),
