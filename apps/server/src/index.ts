...
const generator=createReadingGenerator({provider:config.LLM_PROVIDER,model:config.GEMINI_MODEL,...(config.GEMINI_API_KEY?{apiKey:config.GEMINI_API_KEY}:{})});
